...
wlr8100_mtdlayout=mtdparts=spi0.0:192k(u-boot)ro,64k(u-boot-env)ro,1408k(kernel),14016k(rootfs),256k(manufacture)ro,64k(backup)ro,320k(storage)ro,64k(caldata)ro,15424k@0x40000(firmware)
