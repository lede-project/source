...
#define HIVEAP_121_KEYS_DEBOUNCE_INTERVAL	(3 * HIVEAP_121_KEYS_POLL_INTERVAL)
...
static void __init hiveap_121_setup(void)
{
	...
	ath79_setup_ar934x_eth_cfg(AR934X_ETH_CFG_RGMII_GMAC0 |
 	...
 	ath79_init_mac(ath79_eth0_data.mac_addr, base + HIVEAP_121_MAC_OFFSET, 0);
...
MIPS_MACHINE(ATH79_MACH_HIVEAP_121, "HiveAP-121", "Aerohive HiveAP-121", hiveap_121_setup);
