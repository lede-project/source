...
ucidef_set_led_ataport() {
	__ucidef_set_led_trigger "$1" "$2" "$3" ata"$4"
}

__ucidef_set_led_common() {
	local cfg="led_$1"
	local name="$2"
	local sysfs="$3"
...
ucidef_set_led_ide() {
	__ucidef_set_led_trigger "$1" "$2" "$3" ide-disk
}
...
ucidef_set_led_usbhost() {
	__ucidef_set_led_trigger "$1" "$2" "$3" usb-host
}
...
ucidef_set_led_usbport() {
	...
	__ucidef_set_led_common "$obj" "$name" "$sysfs"
...
ucidef_set_led_wlan() {
	__ucidef_set_led_trigger "$1" "$2" "$3" "$4"
}
