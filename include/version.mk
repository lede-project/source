...
NAME_PREFIX_VERNUM:=$(if $(CONFIG_VERSION_FILENAMES),$(call sanitize,$(VERSION_NUMBER))-)
NAME_PREFIX_VERCODE:=$(if $(CONFIG_VERSION_CODE_FILENAMES),$(call sanitize,$(VERSION_CODE))-)
NAME_PREFIX = $(VERSION_DIST_SANITIZED)-$(if $(1),$(call sanitize,$(1))-)$(NAME_PREFIX_VERNUM)$(NAME_PREFIX_VERCODE)$(BOARD)$(if $(SUBTARGET),-$(SUBTARGET))
TOOLTAR_PREFIX = $(call NAME_PREFIX,$(1))$(if $(GCCV),_gcc-$(GCCV))$(DIR_SUFFIX).$(HOST_OS)-$(HOST_ARCH)
